Notes.Contact  = DS.Model.extend({
  firstName:    DS.attr('string'),
  lastName:     DS.attr('string'),
  email:        DS.attr('string'),
  notes:        DS.attr('string'),
  stocks:       DS.hasMany('Notes.Stock'),
  phoneNumbers: DS.hasMany('Notes.PhoneNumber'),
...
Notes.PhoneNumber = DS.Model.extend({
  number:  DS.attr('string'),
  contact: DS.belongsTo('Notes.Contact')
});

Notes.Stock  = DS.Model.extend({
