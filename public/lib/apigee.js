...
jQuery.getJSON('https://api.usergrid.com/'+ usergrid_request.orgName +'/'+ usergrid_request.appName +'/token?username=' + usergrid_request.username + '&password=' + usergrid_request.password + '&grant_type=password', function(token) {
  console.log('https://api.usergrid.com/'+ usergrid_request.orgName +'/'+ usergrid_request.appName +'/token?username=' + usergrid_request.username + '&password=' + usergrid_request.password + '&grant_type=password');
...
UserGrid.Entity.reopen ({
  name: DS.attr('string',{defaultValue:'wes'})
})
...
//resetting the app only for testing
//    UserGrid.reset();

//    this.entities = UserGrid.Entity.find();
    this.set('entities', UserGrid.Entity.find())
  }
